...
import com.example.matatumanageradmin.utils.web
...
const val CREATE_MAT_ADMIN = "$MAT_ADMIN/create"
const val CREATE_DRIVERS = "$DRIVERS/create"
const val CREATE_BUSES = "$BUSES/create"
const val CREATE_TRIPS = "$TRIPS/create"
const val CREATE_STATS = "$STATS/create"
const val CREATE_EXPENSES = "$EXPENSES/create"
const val UPDATE_MAT_ADMIN = "$MAT_ADMIN/update"
